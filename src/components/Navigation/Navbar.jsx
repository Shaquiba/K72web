...
const navGRef = useRef(null)

const [navOpen, setnavOpen]  =  useContext(NavBarContext)

  return (
    <div className=' z-3 flex fixed top-0 w-full items-start justify-between'>
        <div className='lg:p-4 p-2 bg-black'>
            <div className='lg:w-25 w-10'>
    ...
    <div onClick={()=>{
      ...
      navGRef.current.style.height = '100%'
    }}
    onMouseLeave={()=>{
